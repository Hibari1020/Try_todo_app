class MicropostsController < ApplicationController
    ...
    def create
        ...
        if @micropost.save
          ...
          render 'static_pages/start', status: :unprocessable_entity
        end
    end
    ...
    def done_index
        @done_feed_items = current_user.done_feed.paginate(page: params[:page])
    end
    ...
    private 
       ...
       def correct_user
        # current_user自身のマイクロポストと、フォローしているユーザーのマイクロポストを取得する
